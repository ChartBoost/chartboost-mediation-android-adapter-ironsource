...
android {
    namespace = "com.chartboost.helium.ironsourceadapter"
    compileSdk = 33
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "4.7.2.5.0.0"

        buildConfigField("String", "HELIUM_IRONSOURCE_ADAPTER_VERSION", "\"${android.defaultConfig.versionName}\"")
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("IronSourceAdapter", "aar")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                pom {
                    name.set("Helium Adapter ironSource")
