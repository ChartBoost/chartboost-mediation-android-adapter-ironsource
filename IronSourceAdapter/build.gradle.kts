...
android {
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "5.8.9.0.0.0"
...
dependencies {
    ...
    // Partner SDK
    implementation("com.ironsource.sdk:mediationsdk:8.9.0")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                pom {
                    name.set("Chartboost Mediation Adapter ironSource")
